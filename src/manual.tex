...
\\\\
The user interface can be toggled by the key \keys{3}.  See also Appendix \ref{appendix:G} and \ref{appendix:H} for the world with texture mapping toggled.
...
\\\\
The transparency can be toggled by the key \keys{7}.  Appendix \ref{appendix:C} for a comparison of the transparency pixel.
...
\subsection{World} \label{appendix:A}
\screenshot{world}{The \Blockycraft{} World.}{ScreenshotA}{1.0\textwidth}
\clearpage

\subsection{Perlin} \label{appendix:B}
